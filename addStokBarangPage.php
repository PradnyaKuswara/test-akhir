...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <style>
        ...
        #kode-list {
            max-height: 150px; /* Atur ketinggian maksimum daftar saran */
            overflow-y: auto; /* Aktifkan scroll jika konten melebihi ketinggian maksimum */
            border: 1px solid #ccc; /* Tambahkan garis pinggir untuk estetika */
            list-style: none; /* Hilangkan poin dari daftar */
            padding: 0; /* Hapus padding default dari daftar */
        }
...
?>
    ...
    <div class="form-container">
        <h1><center><span id="clock"></span></center></h1><br>
    ...
    $(document).ready(function() {
        ...
        <input type="submit" name="submit" value="Tambah Transaksi" onclick="return confirm('Are you sure you want to add stock?')">
